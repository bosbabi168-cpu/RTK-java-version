...
local _waypoints = {
	...
	},
    {
		...
		keywords = {"hutan", "persimpangan", "persimpangan hutan", "mantis"},
        includeOnMaps = {},
		excludeOnMap = 522,
		excludeInRegion = -1,
		costFactor = 4,
	...
	},
    {
		...
		keywords = {"thane", "tambang", "menambang"},
        includeOnMaps = {},
		excludeOnMap = -1,
		excludeInRegion = -1,
		costFactor = 3,
